...
export const Game = () => {
  ...
  return (
    <div
      ...
      onMouseDown={status === 'process' ? jump : undefined}
      onTouchStart={status === 'process' ? jump : undefined}
    >
      <div className="absolute z-10 top-14 left-1/2 -translate-x-1/2 flex flex-col text-center gap-4 items-center">
